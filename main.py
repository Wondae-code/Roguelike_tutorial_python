...
def main() -> None:
  ...
  engine.game_map = generate_dungeon(max_rooms=max_rooms, room_min_size=room_min_size, 
  ...
  engine.message_log.add_message("Hello and welcome to yet another dungeon!", color.welcome_text)
  ...
  vsync=True,
    ...
    while True:
      ...
      except Exception: # 게임 내부의 예외를 관리
        traceback.print_exc()
        # 메세지 로그에 에러 출력
